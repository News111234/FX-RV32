...
//
// inst_rom (组合读, 零延迟) 作为指令存储器, $readmemh 加载程序
`timescale 1ns/1ps
...
// ==========================================================================
core_top #(
    .SYNC_INST_MEM(0)                     // inst_rom 组合读, 零延迟
) u_core (
    .clk_i            (clk_i),
    .rst_n_i          (rst_n_i),
    ...
    .extr_gpio_i      (gpio_interrupt),
    .extr_spi_i       (spi_interrupt),
    .extr_i2c_i       (i2c_interrupt)


);

// ==========================================================================
// 指令存储器: inst_rom (组合读, 零延迟, $readmemh 加载)
// ==========================================================================
inst_rom u_inst_rom (
    .addr_i   (core_if_pc),
