...
// 注意: 论文 (bare_jrnl_new_sample4.tex, Table I) 标称默认 DATA_DEPTH = 1024 (4KB)。
//       本文件默认值取 512 以加速综合/仿真; 综合报告取 core_top 面积, 不含本 RAM,
//       故调小不影响论文面积数据。
parameter DATA_DEPTH = 512;                // 512 × 32-bit words = 2KB (论文标称默认 1024/4KB)
