...
# ========== 数据 ==========
tests = {
    'test1_vvadd':   {'cycles': 143,  'color': '#1f77b4', 'marker': 'o', 'label': 'Vector Addition (vvadd)'},
    'test2_fib':     {'cycles': 97,   'color': '#ff7f0e', 'marker': 's', 'label': 'Recursive Fibonacci (fib)'},
    'test3_matmul':  {'cycles': 23,   'color': '#2ca02c', 'marker': '^', 'label': 'Matrix Multiplication (matmul)'},
    'test4_bubble':  {'cycles': 1081, 'color': '#d62728', 'marker': 'd', 'label': 'Bubble Sort (bubble_sort)'},
    # ---- 新增测试5：LFSR ----
    'test5_lfsr':    {'cycles': 2053, 'color': '#9467bd', 'marker': 'v', 'label': 'LFSR (lfsr)'},
}
