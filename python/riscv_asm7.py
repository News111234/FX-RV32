...
class FullRISCVAssembler:
    ...
    def expand_li(self, rd, imm_val):
        ...
        if -2048 <= imm_val <= 2047:
            ...
            if lower == 0:
                code = self.encode_u_type(0b0110111, rd, str(upper << 12))
                instructions.append(code)
            else:
                code1 = self.encode_u_type(0b0110111, rd, str(upper << 12))
    ...
    def encode_j_type(self, opcode, rd, offset):
        ...
        # 提取各个位
        imm20 = (offset_val >> 19) & 0x1
        imm19_12 = (offset_val >> 11) & 0xFF
        imm11 = (offset_val >> 10) & 0x1
    ...
    def assemble_instruction(self, line):
        ...
        if mnemonic == 'la':
            ...
            return self.encode_u_type(0b0010111, rd, '0'), False
